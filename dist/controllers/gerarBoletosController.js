...
exports.gerarBoletosController = void 0;
const prisma_1 = require("../config/prisma");
const errorHandler_1 = require("../middlewares/errorHandler");
exports.gerarBoletosController = {
    /**
    ...
    async gerar(req, res) {
        ...
        if (!contrato)
            throw new errorHandler_1.AppError('Contrato não encontrado ou inativo', 404);
        ...
        for (let i = 0; i < meses; i++) {
            ...
            const novoBoleto = await prisma_1.prisma.boletos.create({
                data: {
...
//# sourceMappingURL=gerarBoletosController.js.map