...
exports.portalResponsavelController = void 0;
const prisma_1 = require("../config/prisma");
const errorHandler_1 = require("../middlewares/errorHandler");
exports.portalResponsavelController = {
    async meusDados(req, res) {
        ...
        if (!idFormatado)
            throw new errorHandler_1.AppError('ID do responsável é obrigatório', 400);
    ...
    async historicoAcademico(req, res) {
        const { responsavelId } = req.query;
        const idFormatado = Array.isArray(responsavelId) ? responsavelId[0] : responsavelId;
        if (!idFormatado)
            throw new errorHandler_1.AppError('ID do responsável é obrigatório', 400);
        ...
        notas.forEach(nota => {
            ...
            if (!porDisciplina[key])
                porDisciplina[key] = { notas: [], soma: 0, total: 0 };
        ...
        const frequencias = await prisma_1.prisma.frequencia.findMany({ where: { alunoId: responsavel.aluno.id } });
...
//# sourceMappingURL=portalResponsavelController.js.map